...
def browser_hub(qtile):
    browser_group = qtile.groups_map["2"]
...
def dashboard_toggle(qtile):
    dashboard_group = qtile.groups_map["5"]
...
def get_keys():
    ...
    qtile_keys = [
        Key(
            [mod],
            "Escape",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-power"),
        ),
        Key(
            [mod],
            "Return",
            lazy.function(terminal_hub),
        ),
        Key(
            [mod, alt],
            "Return",
        ...
        Key(
            [mod, "shift"],
            "Return",
            lazy.spawn(f"{terminal} -T floaty-big"),
        ),
        Key(
            [mod],
            "k",
            lazy.spawn(terminal2),
        ),
        Key(
            [alt],
            "r",
            lazy.spawn("zsh -ic 'themes rotate'"),
        ),
        Key(
            [mod],
            "space",
        ...
        Key(
            [mod, alt],
            "space",
            lazy.spawn(f"{ROFI_SCRIPTS}/quick-actions"),
        ),
        Key(
            [mod, "control"],
            "space",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-scripts"),
        ),
        Key(
            [mod],
            "a",
            lazy.spawn(f"{terminal2} -e btop"),
        ),
        Key(
            [mod, alt],
            "a",
            lazy.spawn(f"{terminal2} --title floaty-big -e sh -c ncdu"),
        ),
        # Browser hub
        Key(
            [mod],
            "b",
            lazy.function(browser_hub),
        ),
        Key(
            [mod, alt],
            "b",
        ...
        Key(
            [mod, "shift"],
            "b",
            lazy.spawn(f"{terminal2} --title floaty-big -e sh -c bt"),
        ),
        # Dashboard
        Key(
            [mod],
        ...
        Key(
            [mod],
            "i",
            lazy.spawn(f"{terminal2} --title floaty-medium -e sh -c fzf-wifi"),
        ),
        Key(
            [mod, alt],
            "i",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-wifi"),
        ),
        Key(
            [mod, alt],
            "l",
        ...
        Key(
            [mod],
            "m",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-mount-usb"),
        ),
        Key(
            [mod, alt],
            "m",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-monitor-switch"),
        ),
        Key(
            [mod],
            "n",
        ...
        Key(
            [mod, "shift"],
            "n",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-notes"),
        ),
        Key(
            [mod],
            "o",
        ...
        Key(
            [mod, "shift"],
            "p",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-power-profile"),
        ),
        Key(
            [mod],
            "q",
        ...
        Key(
            [mod],
            "r",
            lazy.spawn("screenrecord"),
        ),
        Key(
            [mod, alt],
            "r",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-screenrecord"),
        ),
        Key(
            [mod, "shift"],
            "r",
        ...
        Key(
            [mod],
            "s",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-screenshot"),
        ),
        Key(
            [mod, alt],
            "s",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-screenshot-fs"),
        ),
        Key(
            [mod],
            "t",
        ...
        Key(
            [mod, alt],
            "t",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-timewarrior"),
        ),
        Key(
            [mod],
            "v",
            lazy.spawn(f"{terminal2} --title floaty-small -e sh fzf-video-play"),
        ),
        Key(
            [mod, alt],
            "v",
            lazy.spawn(f"{terminal2} --title floaty-tiny -e sh -c fzf-video-tool"),
        ),
        Key(
            [mod, "shift"],
            "v",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-video-tool"),
        ),
        Key(
            [mod],
            "w",
            lazy.spawn(f"{ROFI_SCRIPTS}/rofi-wall"),
        ),
        Key(
            [mod, alt],
            "w",
