...
OUTPUTS = {
    ...
    "tmux.conf.j2": ".config/tmux/tmux-colors.conf",
    ...
    "foot.ini.j2": ".config/foot/current-theme.ini", 
    "kitty.conf.j2": ".config/kitty/colors.conf", 
    ...
    # "eza.yml.j2": "$HOME/.config/eza/theme.yml",
