  ...
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      bind -n M-Right resize-pane -R
       ...
       ########################################################
       # Powerline style statusbar with Nord colors
       ########################################################

       %hidden c_red=#BF616A
       %hidden c_green=#A3BE8C
       %hidden c_yellow=#EBCB8B
       %hidden c_orange=#D08770
       %hidden c_blue=#5E81AC
       %hidden c_purple=#B48EAD
       %hidden c_teal=#8FBCBB
       %hidden c_gray=#4C566A
       %hidden c_gray2=#3B4252
       %hidden c_fg=#D8DEE9
       %hidden c_bg=#2E3440
       %hidden c_text=#ECEFF4
       %hidden c_primary=$c_blue
