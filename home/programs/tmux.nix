...
in {
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      # Left capsule-style session name
      set -g status-left "#[fg=#3B4252,bg=default]#[fg=#D8DEE9,bg=#3B4252] #S #[fg=#3B4252,bg=default]"
...
#[fg=#33658A,bg=default]"
      ...
      # Window status (rounded pill style)
      set -g window-status-separator " "
      set -g window-status-format "#[fg=#3B4252,bg=default]#[fg=#D8DEE9,bg=#3B4252] #I:#W #[fg=#3B4252,bg=default]"
      set -g window-status-current-format "#[fg=#4C566A,bg=default]#[fg=#ECEFF4,bg=#4C566A] #I:#W #[fg=#4C566A,bg=default]"
    '';
  };
}
