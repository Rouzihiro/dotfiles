...
in {
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      # Session name (leftmost segment)
      set -g status-right "\
      #[fg=#3B4252,bg=default]\
      #[fg=#D8DEE9,bg=#3B4252] #S "

      # Current directory (middle segment)
      set -ga status-right "\
      #[fg=#3B4252,bg=#434C5E]\
      ...
      set -ga status-right "\
      #[fg=#4C566A,bg=#86BBD8]\
      #[fg=#2E3440,bg=#86BBD8] #(battery-status | awk '/charging/ {print \"󰂂 \" $2; next} {print $2}') "

      # Time (rightmost segment)
      set -ga status-right "\
      #[fg=#86BBD8,bg=#33658A]\
      #[fg=#D8DEE9,bg=#33658A] %H:%M \
