...
PACMAN_PACKAGES=(
    ...
    "scrot" "maim"             # Screenshot tools (➔ replace 'grim/slurp')
    "xclip"                    # Clipboard (➔ replace 'wl-clipboard')
    "picom"                    # Compositor (optional)
    "rofi"                     # App launcher (works on X11)
    "thunar" "vifm"            # File managers
    "blueman"                  # Bluetooth GUI
    "pamixer"                  # Audio control
    "brightnessctl"            # Screen brightness

    # === Terminal/Shell ===
    "zsh" "starship" "eza" "bat" "fzf"  # Shell enhancements
    "tmux"                     # Terminal multiplexer
    "fastfetch" "duf" "ncdu"   # System info tools
    ...
    # === Multimedia ===
    "ffmpegthumbs" "imagemagick" "vlc" "yt-dlp"

    # === Fonts ===
    "ttf-fira-code-nerd" "ttf-jetbrains-mono-nerd" 
    "ttf-dejavu" "noto-fonts"  # Core fonts
...
configure_services() {
    ...
    #log_info "Enabling system services..."
     sudo systemctl enable lightdm || log_warning "Failed to enable lightdm"
